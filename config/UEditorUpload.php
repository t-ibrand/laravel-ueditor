...
return [
	...
	*/
	...
	'upload'  => [
		...
		"scrawlPathFormat"        => "uploads/ueditor/image/", /* 上传保存路径,可以自定义保存路径和文件名格式 */
		...
		"snapscreenPathFormat"    => "uploads/ueditor/image/", /* 上传保存路径,可以自定义保存路径和文件名格式 */
		...
		"catcherPathFormat"       => "uploads/ueditor/image/", /* 上传保存路径,可以自定义保存路径和文件名格式 */
